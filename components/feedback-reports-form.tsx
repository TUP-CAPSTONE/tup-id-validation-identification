...
export function FeedbackReportForm({
  ...
  const canSubmit = useMemo(() => {
    ...
    if (type === "bug") {
      return (
        stepsToReproduce.trim().length >= 10 &&
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setSuccessMsg("Submitted successfully! Thank you for helping improve TUP SIIVS.")
    ...
    <div className={cn("w-full", className)}>
      <Card className="rounded-2xl shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Help improve <span className="font-medium">TUP SIIVS</span> by sending feedback or reporting bugs.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Label className="text-sm font-medium">What kind of report do you want to submit?</Label>
            <RadioGroup
              value={type}
