...
export default function FeedbackReportsPage() {
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset>
        <header className="bg-linear-to-b from-[#c62c3f] to-[#b32032] text-white sticky top-0 flex h-20 items-center justify-center shadow-md px-4 z-50">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
        ...
        <div className="flex flex-1 flex-col gap-4 p-6">
          <div className="mx-auto w-full max-w-6xl">
            <FeedbackReportForm senderRole="student" />
          </div>
        </div>
      </SidebarInset>
    </SidebarProvider>
